 ...
 * size: 142 bytes
 * params: 0  return: undefined
 * ========================================================= */


void FUN_14020f000(float param_1)

{
  ...
  fVar2 = DAT_1407ffaf8;
  plVar3 = DAT_140a7c688;
  plVar4 = DAT_140a7c680;
  if (DAT_140a7c680 != DAT_140a7c688) {
    do {
      lVar1 = *plVar4;
      if ((*(char *)(lVar1 + 0x20) != '\0') && (fVar2 < param_1 - *(float *)(lVar1 + 0x2c))) {
        *(float *)(lVar1 + 0x2c) = param_1;
        FUN_14020f180(lVar1);
        plVar3 = DAT_140a7c688;
        if (DAT_140a7c678 <= *(int *)(lVar1 + 0x1c)) {
          DAT_140a7c678 = *(int *)(lVar1 + 0x1c);
        }
      }
      plVar4 = plVar4 + 1;
    } while (plVar4 != plVar3);
      ...
      if (*(char *)(param_1 + 0x1c4) != '\0') {
        ...
        if ((local_28 == 0x1c) &&
          ...
          if (iVar3 + iVar2 == iVar4) {
            ...
            FUN_1403b01f0(&DAT_140b2ed18,uVar6);
...
void FUN_1402718e0(undefined4 param_1)

{
  ...
  plVar4 = (longlong *)*DAT_140b0a2e8;
  if (plVar4 != DAT_140b0a2e8) {
    do {
      lVar2 = plVar4[2];
      if ((*(char *)(lVar2 + 0x1d) == '\0') && (*(longlong *)(lVar2 + 0x10) != 0)) {
        FUN_140265280(*(longlong *)(lVar2 + 0x10),param_1,0);
        iVar1 = *(int *)(lVar2 + 0x18);
        if ((-1 < iVar1) && (*(char *)(lVar2 + 0x1f) == '\0')) {
          uVar3 = FUN_1402648b0(*(undefined8 *)(lVar2 + 0x10));
          FUN_14012d2c0(uVar3,iVar1);
          FUN_140261bd0(*(undefined8 *)(lVar2 + 8),local_48);
        }
      }
      plVar4 = (longlong *)*plVar4;
    } while (plVar4 != DAT_140b0a2e8);
  }
  plVar4 = (longlong *)*DAT_140b0a2f8;
  if (plVar4 != DAT_140b0a2f8) {
    do {
      lVar2 = plVar4[2];
      if ((*(char *)(lVar2 + 0x1d) == '\0') && (*(longlong *)(lVar2 + 0x10) != 0)) {
        FUN_140265280(*(longlong *)(lVar2 + 0x10),param_1,0);
