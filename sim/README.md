...
| entity-update spine | `3639d0` `2be640` `3a6b80` | ⬜ next | GOM iteration order; child-recursion order |
| locomotor integrators | `6236b0` `61e930` + … | ⬜ | per-type state machine; writes `entity+0x78` |
