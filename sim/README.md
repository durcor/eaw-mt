...
| **locomotor integrators** | `6236b0` `6224b0` `4c2f70` `3a8f90` `623340` `4aaa40` `2bab90` `559250` `370f00` | ✅ Starship skeleton + data model + primitives + **accel→velocity integrator** lifted; steering bodies (`622b80`/`622e90`) + other types still behind `LocomotorEnv` | reads/writes `entity+0x78`; `integrate_velocity` (accel·heading→velocity, speed cap, steer damp, drag); arrival FSM fires cross-entity events (Phase B); game-speed/steer constants need binary values for oracle |
